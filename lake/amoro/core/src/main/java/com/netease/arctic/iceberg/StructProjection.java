...
/**
 * Copy from iceberg {@link org.apache.iceberg.util.StructProjection}. Add
 * {@link StructProjection#copyWrap(StructLike)} method to create StructProjection cheap
 */
public class StructProjection implements StructLike {
  ...
  private StructProjection(
      ...
      int[] positionMap,
      StructProjection[] nestedProjections) {
    this.type = type;
