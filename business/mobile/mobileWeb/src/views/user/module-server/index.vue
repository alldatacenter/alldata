<template>
  <div>
    ...
    <van-popup v-model="showKefu">
      <van-cell-group>
        <van-cell title="项目名称" value="mall-shopping-mobile" />
        <van-cell title="项目地址" value="Github"  url="https://github.com/wlhbdp/bdp-platform/tree/master/mall-shopping-mobile"/>
      </van-cell-group>
    </van-popup>
  </div>
</template>
