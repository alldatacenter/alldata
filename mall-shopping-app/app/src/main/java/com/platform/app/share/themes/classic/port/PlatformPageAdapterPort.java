...
package com.platform.app.share.themes.classic.port;
...
import com.platform.app.share.themes.classic.PlatformPage;
import com.platform.app.share.themes.classic.PlatformPageAdapter;
...
public class PlatformPageAdapterPort extends PlatformPageAdapter {
	...
	private static final int LINE_SIZE_P = 5;       //每行显示的数量
