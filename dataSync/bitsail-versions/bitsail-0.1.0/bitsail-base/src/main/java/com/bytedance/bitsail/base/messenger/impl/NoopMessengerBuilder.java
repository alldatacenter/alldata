 ...
 * Created 2022/8/31
 */
public class NoopMessengerBuilder<T> implements MessengerBuilder<T> {
  @Override
  ...
  @Override
  public Messenger<T> createMessenger(MessengerContext messengerContext) {
    return new NoOpMessenger<>();
  }
}
