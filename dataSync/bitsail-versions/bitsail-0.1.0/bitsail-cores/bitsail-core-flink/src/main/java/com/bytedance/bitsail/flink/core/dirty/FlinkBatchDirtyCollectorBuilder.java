 ...
 * Created 2022/8/31
 */
public class FlinkBatchDirtyCollectorBuilder implements DirtyCollectorBuilder {

  @Override
  public AbstractDirtyCollector createDirtyCollector(BitSailConfiguration commonConfiguration,
                                                     MessengerContext messengerContext) {
    return new FlinkBatchDirtyCollector(commonConfiguration, messengerContext);
  }
