...
import com.platform.quality.configuration.dqdefinition.{MeasureParam, RuleOutputParam, SinkParam}
import com.platform.quality.configuration.enums.MeasureTypes

import scala.collection.mutable
import org.apache.spark.sql.functions._
import org.apache.griffin.measure.configuration.dqdefinition._
import com.platform.quality.configuration.enums.FlattenType.DefaultFlattenType
import com.platform.quality.execution.Measure._
...
class CustomSinkTest extends SinkTestBase {
  ...
  val sinkParam: SinkParam =
    SinkParam(
      "mysqlSink",
      "custom",
      Map("class" -> "org.apache.griffin.measure.sink.MysqlSink"))
