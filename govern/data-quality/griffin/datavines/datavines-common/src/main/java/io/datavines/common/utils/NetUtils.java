...
public class NetUtils {
    ...
    public static String getHost() {
        ...
        return CommonConstants.KUBERNETES_MODE ? "localhost" : "127.0.0.1";
    }
    ...
    private static synchronized InetAddress getLocalAddress0() {
        ...
        addressOp.ifPresent(inetAddress -> LOCAL_ADDRESS = inetAddress);
        return LOCAL_ADDRESS;
    }
    ...
    private static boolean isSpecifyNetworkInterface(NetworkInterface networkInterface) {
        String preferredNetworkInterface = CommonPropertyUtils.getString(CommonConstants.NETWORK_INTERFACE_PREFERRED,
                System.getProperty(CommonConstants.NETWORK_INTERFACE_PREFERRED));
    ...
    private static NetworkInterface findAddress(List<NetworkInterface> validNetworkInterfaces) {
        ...
        String networkPriority = CommonPropertyUtils.getString(CommonConstants.NETWORK_PRIORITY_STRATEGY, NETWORK_PRIORITY_DEFAULT);
