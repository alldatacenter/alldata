...
import com.platform.quality.step.builder.dsl.expr.{Expr, UniquenessClause}
import com.platform.quality.step.builder.dsl.transform.analyzer.UniquenessAnalyzer
...
case class UniquenessExpr2DQSteps(context: DQContext, expr: Expr, ruleParam: RuleParam)
  ...
  def getDQSteps: Seq[DQStep] = {
    ...
    val analyzer = analyzer.UniquenessAnalyzer(uniquenessExpr, sourceName, targetName)
