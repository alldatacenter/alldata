...
@Data
public class JobExecutionResponseContext implements Serializable {

    private CommandCode commandCode;

    private JobExecutionRequest jobExecutionRequest;

    public JobExecutionResponseContext() {
    }

    public JobExecutionResponseContext(CommandCode commandCode, JobExecutionRequest jobExecutionRequest) {
