...
public class ActualValueDataSinkExecutor extends BaseDataSinkExecutor {

    protected Logger log = LoggerFactory.getLogger(ActualValueDataSinkExecutor.class);

    public ActualValueDataSinkExecutor(Config config, LocalRuntimeEnvironment env) {
        super(config, env);
