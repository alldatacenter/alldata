 ...
 */
package io.datavines.engine.spark.executor.utils;

import static io.datavines.common.CommonConstants.SINGLE_QUOTES;
...
public class StringUtils {
    ...
    public static String replaceDoubleBrackets(String mainParameter) {
        mainParameter = mainParameter
                .replace(DOUBLE_BRACKETS_LEFT, DOUBLE_BRACKETS_LEFT_SPACE)
                .replace(DOUBLE_BRACKETS_RIGHT, DOUBLE_BRACKETS_RIGHT_SPACE);
        if (mainParameter.contains(DOUBLE_BRACKETS_LEFT) || mainParameter.contains(DOUBLE_BRACKETS_RIGHT)) {
