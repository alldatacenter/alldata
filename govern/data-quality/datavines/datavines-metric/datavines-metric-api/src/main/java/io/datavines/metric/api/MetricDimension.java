...
public enum MetricDimension {
    ...
    MetricDimension(int code, String description) {
        this.code = code;
    ...
    private static final Map<Integer, MetricDimension> VALUES_MAP = new HashMap<>();
    ...
    public static MetricDimension of(Integer status) {
