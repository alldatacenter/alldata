...
define(function(require){
        ...
        var RangerZoneListBase = XABaseCollection.extend(
        /** @lends RangerZoneListBase.prototype */
        {
                url: XAGlobals.baseURL + 'zones/zones',

                model : RangerZone,

                /**
                 * RangerZoneListBase initialize method
