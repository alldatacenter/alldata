...
define(function(require) {
    ...
    var RangerZoneResourceForm = Backbone.Form.extend(
        /** @lends RangerZoneResourceForm */
        {
            _viewName: 'RangerZoneResourceForm',

            /**
             * intialize a new RangerZoneResourceForm Form View
             * @constructs
             */
