...
package com.platform.explainer.sqllineage;

import com.platform.explainer.lineage.LineageRelation;
import com.platform.explainer.lineage.LineageResult;
import com.platform.explainer.lineage.LineageTable;
...
import com.platform.utils.module.Asserts;
import com.platform.utils.module.Column;
import com.platform.utils.module.Driver;
import com.platform.utils.module.DriverConfig;
        ...
        try {
            ...
            if (sqlStatement instanceof SQLInsertStatement) {
                ...
                for (String tableName : tableMap.keySet()) {
                    ...
                    List<com.platform.explainer.lineage.LineageColumn> tableColumns = new ArrayList<>();
                    Set<String> tableSet = new HashSet<>();
                    for (TableStat.Column column : allColumnList) {
                        if (tableName.equals(column.getTable()) && !tableSet.contains(column.getName())) {
                            tableColumns.add(new com.platform.explainer.lineage.LineageColumn(column.getName(), column.getName()));
