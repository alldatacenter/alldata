...
import com.platform.utils.job.LineageRel;
import com.platform.utils.job.SqlExplainResult;
...
public class CustomTableEnvironmentImpl extends AbstractStreamTableEnvironmentImpl
    ...
    public static CustomTableEnvironmentImpl create(
        ...
        final CatalogManager catalogManager =
                CatalogManager.newBuilder()
                        ...
                        .build();
        ResourceManager resourceManager = ResourceManager.createResourceManager(new URL[]{}, classLoader, tableConfig);
    ...
    public <T> Table fromDataStream(DataStream<T> dataStream, String fields) {
        List<Expression> expressions = Collections.singletonList(unresolvedRef(fields));
