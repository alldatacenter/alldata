...
import com.platform.quality.step.builder.dsl.expr.{DistinctnessClause, Expr}
import com.platform.quality.step.builder.dsl.transform.analyzer.DistinctnessAnalyzer
...
import com.platform.quality.step.DQStep
...
case class DistinctnessExpr2DQSteps(context: DQContext, expr: Expr, ruleParam: RuleParam)
  ...
  def getDQSteps: Seq[DQStep] = {
    ...
    val analyzer = analyzer.DistinctnessAnalyzer(distinctnessExpr, sourceName)
