...
public class SwModel implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getStatPeriod() == null ? other.getStatPeriod() == null : this.getStatPeriod().equals(other.getStatPeriod()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getStatPeriod() == null) ? 0 : getStatPeriod().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", statPeriod=").append(statPeriod);
