 ...
 * @author tandong
 * @Description:TODO
 * @date 2019/3/20 23:39
 */
@Component("dataBaseAuthServiceManager")
@Slf4j
public class DataBaseAuthServiceManager implements AuthServiceManager {
    ...
    @Override
    public List<UserPermissionsVO> getPermissionsByUserId(UserDO loginuser, String appId) throws ApplicationException {
