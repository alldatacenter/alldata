{
    ...
    "services": [
        ...
        {
            "serviceCode": "apiManage",
            "serviceName": "API 管理",
            "memo": "API 管理",
            "isOpen": 1,
            "permissions": [
                {
                    "permissionCode": "apiManage.api.access",
                    "permissionType": 0,
                    "isEnable": 1,
                    "permissionName": "API 管理访问权限",
                    "applyUrl": "",
                    "memo": "API 管理访问权限"
                }
            ]
        ...
        {
            "serviceCode": "actionAudit",
            "serviceName": "操作审计",
            "memo": "操作审计",
            "isOpen": 1,
            "permissions": [
                {
                    "permissionCode": "actionAudit.api.access",
                    "permissionType": 0,
                    "isEnable": 1,
                    "permissionName": "操作审计访问权限",
                    "applyUrl": "",
                    "memo": "操作审计访问权限"
                }
            ]
