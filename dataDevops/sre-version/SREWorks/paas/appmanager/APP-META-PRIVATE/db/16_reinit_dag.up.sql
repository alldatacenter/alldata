...
) ENGINE=InnoDB AUTO_INCREMENT=64312 DEFAULT CHARSET=utf8mb4;
...
) ENGINE=InnoDB AUTO_INCREMENT=67036 DEFAULT CHARSET=utf8mb4;
...
) ENGINE=InnoDB AUTO_INCREMENT=143945 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `tc_dag_inst_node_std` (
  ...
  KEY `idx_lock_id` (`lock_id`) USING BTREE,
  KEY `idx_standalone_ip` (`standalone_ip`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=65663 DEFAULT CHARSET=utf8mb4;
