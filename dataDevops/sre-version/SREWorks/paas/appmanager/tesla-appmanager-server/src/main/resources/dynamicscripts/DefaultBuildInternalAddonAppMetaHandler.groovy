 ...
 */
class DefaultInternalAddonAppMetaHandler implements BuildComponentHandler {

    private static final Logger log = LoggerFactory.getLogger(DefaultInternalAddonAppMetaHandler.class)

    /**
     * 当前内置 Handler 类型
     */
    public static final String KIND = DynamicScriptKindEnum.BUILD_IA_APP_META_COMPONENT.toString()
