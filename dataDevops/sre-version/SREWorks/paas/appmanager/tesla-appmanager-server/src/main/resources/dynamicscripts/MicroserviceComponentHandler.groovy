 ...
 */
class MicroserviceComponentHandler implements ComponentHandler {

    /**
     * Handler 元信息
     */
    public static final String KIND = "COMPONENT"
    public static final String NAME = "K8S_MICROSERVICE"
    ...
    String watchScriptName() {
        return "MicroserviceInformerRegister"
    }
}
