...
class BizHeatMap extends Component {
    ...
    render() {
        ...
        let { theme, appendPadding, xField,yField, chartTitle, colorField, sizeField, height = '', width, advancedConfig = {} } = widgetConfig;
        ...
        return (
            <HeatmapChart appendPadding={appendPadding || [10, 0, 0, 10]}
                theme={theme || 'light'}
