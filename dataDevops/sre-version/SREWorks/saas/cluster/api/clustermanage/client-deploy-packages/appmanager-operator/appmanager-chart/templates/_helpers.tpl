...
{{- else -}}
{{- printf "%s/%s:%s" .Values.images.registry "sw-paas-appmanager" .Values.images.tag -}}
{{- end -}}
{{- end -}}
...
{{- else -}}
{{- printf "%s/%s:%s" .Values.images.registry "sw-paas-appmanager-operator" .Values.images.tag -}}
{{- end -}}
{{- end -}}
...
{{- else -}}
{{- printf "%s/%s:%s" .Values.images.registry "sw-paas-appmanager-db-migration" .Values.images.tag -}}
{{- end -}}
{{- end -}}
...
{{- else -}}
{{- printf "%s/%s:%s" .Values.images.registry "sw-paas-appmanager-postrun" .Values.images.tag -}}
{{- end -}}
{{- end -}}
...
{{- else -}}
{{- printf "%s/%s:%s" .Values.images.registry "sw-paas-appmanager-cluster-init" .Values.images.tag -}}
{{- end -}}
{{- end -}}
