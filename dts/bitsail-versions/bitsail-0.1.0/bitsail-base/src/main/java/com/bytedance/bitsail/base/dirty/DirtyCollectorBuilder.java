 ...
 * Created 2022/8/31
 */
public interface DirtyCollectorBuilder extends ComponentBuilder<AbstractDirtyCollector> {

  AbstractDirtyCollector createDirtyCollector(BitSailConfiguration commonConfiguration,
