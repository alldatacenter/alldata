...
package com.bytedance.bitsail.connector.legacy.hudi.source.format.cow;

import com.bytedance.bitsail.connector.legacy.hudi.source.format.cow.vector.HeapArrayVector;
import com.bytedance.bitsail.connector.legacy.hudi.source.format.cow.vector.HeapMapColumnVector;
import com.bytedance.bitsail.connector.legacy.hudi.source.format.cow.vector.HeapRowColumnVector;
import com.bytedance.bitsail.connector.legacy.hudi.source.format.cow.vector.ParquetDecimalVector;
import com.bytedance.bitsail.connector.legacy.hudi.source.format.cow.vector.reader.ArrayColumnReader;
import com.bytedance.bitsail.connector.legacy.hudi.source.format.cow.vector.reader.FixedLenBytesColumnReader;
import com.bytedance.bitsail.connector.legacy.hudi.source.format.cow.vector.reader.Int64TimestampColumnReader;
import com.bytedance.bitsail.connector.legacy.hudi.source.format.cow.vector.reader.MapColumnReader;
import com.bytedance.bitsail.connector.legacy.hudi.source.format.cow.vector.reader.ParquetColumnarRowSplitReader;
import com.bytedance.bitsail.connector.legacy.hudi.source.format.cow.vector.reader.RowColumnReader;
    ...
    switch (type.getTypeRoot()) {
      ...
      case VARBINARY:
        ...
        if (value == null) {
          ...
          bsv.fill(value instanceof byte[] ? (byte[]) value
