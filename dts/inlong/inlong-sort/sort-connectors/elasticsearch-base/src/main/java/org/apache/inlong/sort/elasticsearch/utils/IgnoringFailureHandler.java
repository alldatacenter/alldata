 ...
 * Copies from {@link org.apache.flink.streaming.connectors.elasticsearch.util.IgnoringFailureHandler}
 *
 * @param <ActionRequest>
 */
public class IgnoringFailureHandler<ActionRequest> implements ActionRequestFailureHandler<ActionRequest> {

    private static final long serialVersionUID = 1L;

    @Override
    public void onFailure(ActionRequest actionRequest, Throwable failure, int restStatusCode,
