...
public class WorkflowListenerException extends WorkflowException {
    ...
    public WorkflowListenerException(String message) {
        super(message);
    }

    public WorkflowListenerException(String message, Throwable cause) {
        super(message, cause);
    }

    public WorkflowListenerException(Throwable cause) {
        super(cause);
    }
