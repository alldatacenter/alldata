            ...
            public void run() {
                ...
                while (!toStop) {
                    ...
                    try {
                        ...
                        if (!toStop) {
                            logger.error(">>>>>>>>>>> AllDataDC, job log report thread error:{}", e);
                        }
                    }
                ...
                logger.info(">>>>>>>>>>> AllDataDC, job log report thread stop");

            }
        });
        logrThread.setDaemon(true);
        logrThread.setName("AllDataDC, admin JobLogReportHelper");
        logrThread.start();
    }
