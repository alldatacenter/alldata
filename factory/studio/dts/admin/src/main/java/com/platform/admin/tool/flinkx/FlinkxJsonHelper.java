...
import com.platform.admin.tool.pojo.*;
import com.platform.admin.tool.flinkx.reader.HanaReader;
import com.platform.admin.tool.flinkx.reader.SqlServerReader;
...
import com.platform.admin.dto.ClickhouseReaderDto;
import com.platform.admin.dto.ClickhouseWriterDto;
import com.platform.admin.dto.FlinkXJsonBuildDto;
import com.platform.admin.dto.HbaseReaderDto;
import com.platform.admin.dto.HbaseWriterDto;
import com.platform.admin.dto.HiveReaderDto;
import com.platform.admin.dto.HiveWriterDto;
import com.platform.admin.dto.MongoDBReaderDto;
import com.platform.admin.dto.MongoDBWriterDto;
import com.platform.admin.dto.RdbmsReaderDto;
import com.platform.admin.dto.RdbmsWriterDto;
import com.platform.admin.tool.flinkx.reader.ClickHouseReader;
import com.platform.admin.tool.flinkx.reader.HBaseReader;
import com.platform.admin.tool.flinkx.reader.HiveReader;
import com.platform.admin.tool.flinkx.reader.MongoDBReader;
import com.platform.admin.tool.flinkx.reader.MysqlReader;
import com.platform.admin.tool.flinkx.reader.OracleReader;
import com.platform.admin.tool.flinkx.reader.PostgresqlReader;
import com.platform.admin.tool.flinkx.writer.ClickHouseWriter;
import com.platform.admin.tool.flinkx.writer.HBaseWriter;
import com.platform.admin.tool.flinkx.writer.HanaWriter;
import com.platform.admin.tool.flinkx.writer.HiveWriter;
import com.platform.admin.tool.flinkx.writer.MongoDBWriter;
import com.platform.admin.tool.flinkx.writer.MysqlWriter;
import com.platform.admin.tool.flinkx.writer.OraclelWriter;
import com.platform.admin.tool.flinkx.writer.PostgresqllWriter;
import com.platform.admin.tool.flinkx.writer.SqlServerlWriter;
import lombok.Data;
