 ...
 *
 * @author AllDataDC 2023-01-03 21:08:07
 */
public class JobTriggerPoolHelper {
    ...
    public void start() {
        fastTriggerPool = new ThreadPoolExecutor(
                ...
                new ThreadFactory() {
                    ...
                    public Thread newThread(Runnable r) {
                        return new Thread(r, "AllDataDC, admin JobTriggerPoolHelper-fastTriggerPool-" + r.hashCode());
                    }
                });
        ...
        slowTriggerPool = new ThreadPoolExecutor(
                ...
                new ThreadFactory() {
                    @Override
                    public Thread newThread(Runnable r) {
                        return new Thread(r, "AllDataDC, admin JobTriggerPoolHelper-slowTriggerPool-" + r.hashCode());
                    }
                });
    }
    ...
    public void stop() {
        ...
        logger.info(">>>>>>>>> AllDataDC trigger thread pool shutdown success.");
    }
