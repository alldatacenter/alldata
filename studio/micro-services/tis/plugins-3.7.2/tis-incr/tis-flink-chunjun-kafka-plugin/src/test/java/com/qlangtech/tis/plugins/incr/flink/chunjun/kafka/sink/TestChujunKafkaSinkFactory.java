 ...
 * @create: 2023-03-21 13:12
 **/
public class TestChujunKafkaSinkFactory {

    @Test
    public void testDescGenerate() {

        PluginDesc.testDescGenerate(ChujunKafkaSinkFactory.class, "chunjun-kafka-sink-descriptor.json");
