...
/**
 * The visitor definition of {@link org.apache.flink.table.types.logical.LogicalType}. The visitor transforms a logical type into
 * instances of {@code R}.
 *
 * <p>Incomplete types such as the {@link TypeInformationRawType} or {@link
 * UnresolvedUserDefinedType} are visited through the generic .
 *
 * @param <R> result type
 */
@PublicEvolving
