...
// cache and queue.
func AddScheduleEventHandler(sched *scheduler.Scheduler, internalHandler SchedulerInternalHandler, koordSharedInformerFactory koordinatorinformers.SharedInformerFactory) {
