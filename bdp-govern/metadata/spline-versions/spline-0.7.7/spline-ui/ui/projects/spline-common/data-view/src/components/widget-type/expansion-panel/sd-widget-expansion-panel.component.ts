...
import { SdWidgetWithChildrenComponent } from '../sd-widget-with-children.component'
...
export class SdWidgetExpansionPanelComponent
    extends SdWidgetWithChildrenComponent<SdWidgetExpansionPanel.Data, SdWidgetExpansionPanel.Options> {
