...
package com.platform.quality.measure.repo;
...
public class DataConnectorRepoTest {
    ...
    public void setEntityManager() throws Exception {
        DataConnector dc1 = EntityMocksHelper.createDataConnector("name1", "database1", "table1",
                "/dt=#YYYYMM#");

        entityManager.persistAndFlush(dc1);

        DataConnector dc2 = EntityMocksHelper.createDataConnector("name2", "database2", "table2",
                "/dt=#YYYYMM#");
        entityManager.persistAndFlush(dc2);

        DataConnector dc3 = EntityMocksHelper.createDataConnector("name3", "database3", "table3",
                "/dt=#YYYYMM#");
