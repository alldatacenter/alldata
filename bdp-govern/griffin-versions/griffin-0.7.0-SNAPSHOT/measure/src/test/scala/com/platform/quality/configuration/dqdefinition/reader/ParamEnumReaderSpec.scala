...
import com.platform.quality.configuration.dqdefinition.{DQConfig, EvaluateRuleParam, RuleOutputParam, RuleParam}
import org.scalatest.flatspec.AnyFlatSpec
import org.scalatest.matchers.should._
import org.apache.griffin.measure.configuration.dqdefinition._

class ParamEnumReaderSpec extends AnyFlatSpec with Matchers {
  import com.platform.quality.configuration.enums.DslType._
  ...
  "dqtype" should "be parsed to predefined set of values" in {
    import com.platform.quality.configuration.enums.DqType._
  ...
  "flattentype" should "be valid" in {
    import com.platform.quality.configuration.enums.FlattenType._
    var ruleOutputParam = RuleOutputParam("metric", "", "map")
  ...
  "sinktype" should "be valid" in {
    ...
    import com.platform.quality.configuration.enums.SinkType._
    var dqConfig = DQConfig(
      ...
      List(
        ...
        "hdfs",
        "MySql"))
    dqConfig.getValidSinkTypes should be(Seq(Console, ElasticSearch, MongoDB, Hdfs, MySql))
    dqConfig = DQConfig(
      "test",
      1234,
      "",
