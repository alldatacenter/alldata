...
package com.platform.quality.transformations

import com.platform.quality.SparkSuiteBase
import com.platform.quality.configuration.dqdefinition
import com.platform.quality.configuration.dqdefinition.{DataConnectorParam, DataSourceParam, EvaluateRuleParam, RuleParam}
...
import com.platform.quality.configuration.enums.ProcessType.BatchProcessType
...
class AccuracyTransformationsIntegrationTest
  ...
  private def checkAccuracy(
    ...
    val dqContext: DQContext = getDqContext(dataSourcesParam = List(
      dqdefinition.DataSourceParam(name = "source", connector = dataConnectorParam(tableName = sourceName)),
      dqdefinition.DataSourceParam(name = "target", connector = dataConnectorParam(tableName = targetName))))
