...
package com.platform.quality.launch.streaming

import com.platform.quality.Loggable
import com.platform.quality.configuration.dqdefinition.{DQConfig, EnvConfig, EvaluateRuleParam, GriffinConfig, SinkParam, SparkParam}
import com.platform.quality.context.streaming.checkpoint.lock.CheckpointLock
import com.platform.quality.context.streaming.checkpoint.offset.OffsetCheckpointClient
import com.platform.quality.context.streaming.metric.CacheResults
...
import com.platform.quality.configuration.enums.ProcessType.StreamingProcessType
import com.platform.quality.context.{ContextId, DQContext}
import com.platform.quality.datasource.DataSourceFactory
import com.platform.quality.job.DQJob
import com.platform.quality.job.builder.DQJobBuilder
import com.platform.quality.launch.DQApp
import com.platform.quality.sink.Sink
import com.platform.quality.step.builder.udf.GriffinUDFAgent
import com.platform.quality.utils.{HdfsUtil, TimeUtil}
...
case class StreamingDQApp(allParam: GriffinConfig) extends DQApp {
  ...
  case class StreamingDQCalculator(globalContext: DQContext, evaluateRuleParam: EvaluateRuleParam)
    ...
    def run(): Unit = {
      ...
      if (locked) {
        try {
          import com.platform.quality.utils.CommonUtils
