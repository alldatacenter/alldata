...
package com.platform.quality.configuration.enums
 ...
 *  <li>{@link #Unknown} - </li>
 *  <li>{@link #MySql} - 新增MySql sink, alias=MySql</li>
 */
object SinkType extends GriffinEnum {
  type SinkType = Value

  val Console, Log, Hdfs, Es, Http, ElasticSearch, MongoDB, Mongo, Custom, MySql =
    Value
