...
public class JobControllerTest {
    ...
    public void testGetJobs() throws Exception {
        AbstractJob jobBean = EntityMocksHelper.createGriffinJob();
    ...
    public void testDeleteJobByIdForFailureWithNotFound() throws Exception {
        Mockito.doThrow(new GriffinException.NotFoundException(GriffinExceptionMessage.JOB_ID_DOES_NOT_EXIST))
    ...
    public void testDeleteJobByNameForFailureWithNotFound() throws Exception {
        String jobName = "jobName";
        doThrow(new GriffinException.NotFoundException(GriffinExceptionMessage.JOB_NAME_DOES_NOT_EXIST))
    ...
    public void testFindInstanceForFailureWithNotFound() throws Exception {
        Long id = 1L;
        doThrow(new GriffinException.NotFoundException(GriffinExceptionMessage.INSTANCE_ID_DOES_NOT_EXIST))
