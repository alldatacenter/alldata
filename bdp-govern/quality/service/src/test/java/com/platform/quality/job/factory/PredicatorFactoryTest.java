...
package com.platform.quality.job.factory;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.platform.quality.exception.GriffinException;
import com.platform.quality.job.FileExistPredicator;
import com.platform.quality.job.Predicator;
import com.platform.quality.util.EntityMocksHelper;
import com.platform.quality.util.PredicatorMock;
...
public class PredicatorFactoryTest {
    ...
    public void testFileExistPredicatorCreation() throws IOException {
        Predicator predicator = PredicatorFactory.newPredicateInstance(EntityMocksHelper.createFileExistPredicate());
