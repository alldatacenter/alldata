...
public class MeasureServiceImplTest {
    ...
    public void testDeleteMeasureByIdForGriffinSuccess() throws Exception {
        GriffinMeasure measure = EntityMocksHelper.createGriffinMeasure("view_item_hourly");
        measure.setId(1L);
    ...
    public void testDeleteMeasureByIdForExternalSuccess() throws
            SchedulerException {
        ExternalMeasure measure = EntityMocksHelper.createExternalMeasure("externalMeasure");
        measure.setId(1L);
        given(measureRepo.findByIdAndDeleted(measure.getId(), false))
                .willReturn(measure);
    ...
    public void testDeleteMeasureByIdForGriffinFailureWithException() throws
            Exception {
        GriffinMeasure measure = EntityMocksHelper.createGriffinMeasure("externalMeasure");
        measure.setId(1L);
        given(measureRepo.findByIdAndDeleted(measure.getId(), false))
                .willReturn(measure);
    ...
    public void testCreateMeasureForGriffinSuccess() throws Exception {
        ...
        GriffinMeasure griffinMeasure = EntityMocksHelper.createGriffinMeasure(measureName);
    ...
    public void testCreateMeasureForExternalSuccess() {
        String measureName = "view_item_hourly";
        ExternalMeasure externalMeasure = EntityMocksHelper.createExternalMeasure(measureName);
        given(measureRepo.findByNameAndDeleted(measureName, false))
                .willReturn(new ArrayList<>());
    ...
    public void testUpdateMeasureForGriffinFailureWithDiffType() throws
            Exception {
        Measure griffinMeasure = EntityMocksHelper.createGriffinMeasure("view_item_hourly");
        Measure externalMeasure = EntityMocksHelper.createExternalMeasure("externalName");
    ...
    public void testUpdateMeasureForExternal() {
        ExternalMeasure measure = EntityMocksHelper.createExternalMeasure
