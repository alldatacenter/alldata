...
public class ExternalMeasureOperatorImplTest {
    ...
    public void testCreateForSuccess() {
        ExternalMeasure measure = EntityMocksHelper.createExternalMeasure("view_item_hourly");
    ...
    public void testCreateForFailureWithBlankMetricName() {
        ...
        ExternalMeasure measure = EntityMocksHelper.createExternalMeasure(measureName);
