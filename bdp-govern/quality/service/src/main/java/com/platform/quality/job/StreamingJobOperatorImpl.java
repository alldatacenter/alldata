...
import static com.platform.quality.job.JobServiceImpl.START;
import static com.platform.quality.job.JobServiceImpl.STOP;
...
import static com.platform.quality.job.entity.LivySessionStates.convert2QuartzState;
    ...
    private void verifyJobState(AbstractJob job) throws SchedulerException {
        ...
        if (!CollectionUtils.isEmpty(triggers)) {
            throw new GriffinException.BadRequestException
                (GriffinExceptionMessage.STREAMING_JOB_IS_RUNNING);
        }
