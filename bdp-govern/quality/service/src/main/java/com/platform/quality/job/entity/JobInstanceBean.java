...
import com.platform.quality.measure.entity.AbstractAuditableEntity;
...
public class JobInstanceBean extends AbstractAuditableEntity {
    ...
    @Enumerated(EnumType.STRING)
    private GriffinMeasure.ProcessType type = GriffinMeasure.ProcessType.BATCH;
    ...
    public String toString() {
        return "JobInstanceBean{" +
                ...
                ", predicateDeleted=" + predicateDeleted +
                ", deleted=" + deleted +
                ", job=" + job +
