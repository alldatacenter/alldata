...
import static com.platform.quality.job.JobServiceImpl.GRIFFIN_JOB_ID;
...
import com.platform.quality.util.TimeUtil;
...
import com.platform.quality.job.entity.SegmentRange;
...
public class JobInstance implements Job {
    ...
    private void setJobDataMap(JobDetail jobDetail, String pJobName)
        ...
        preProcessMeasure();
        String result = JsonUtil.toJson(measure);
    ...
    private void preProcessMeasure() throws IOException {
        for (DataSource source : measure.getDataSources()) {
            ...
            String cache = JsonUtil.toJson(cacheMap);
            ...
            cacheMap = JsonUtil.toEntity(cache, Map.class);
