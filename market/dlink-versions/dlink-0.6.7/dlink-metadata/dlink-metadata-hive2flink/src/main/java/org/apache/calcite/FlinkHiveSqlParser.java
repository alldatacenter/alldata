 ...
 * Hive2FlinkDriver
 * 解析Hive SQL
 * Support RUNNING HIVE SQL ON Flink
 */
class FlinkHiveSqlParser extends SqlParserTest {

    @Override
    protected SqlParserImplFactory parserImplFactory() {
        return org.apache.flink.sql.parser.hive.impl.FlinkHiveSqlParserImpl.FACTORY;
    }
