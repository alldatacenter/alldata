...
import { sortCreator } from 'msp/monitor/mobile-insight/common/utils';
import { sortRender, chartRender } from 'msp/monitor/mobile-insight/common/components/miRenderFactory';
import TablePanel from 'msp/monitor/mobile-insight/common/components/table-panel';
import SlowTrace from 'msp/monitor/mobile-insight/common/components/slow-track-panel';
