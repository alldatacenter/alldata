...
var NodeServiceService = exports.NodeServiceService = {
  register: {
    path: '/grpc.NodeService/Register',
    requestStream: false,
  ...
  sendHeartbeat: {
    path: '/grpc.NodeService/SendHeartbeat',
    requestStream: false,
    responseStream: false,
    requestType: entity_request_pb.Request,
    responseType: entity_response_pb.Response,
  ...
  subscribe: {
    path: '/grpc.NodeService/Subscribe',
    requestStream: false,
    responseStream: true,
    requestType: entity_request_pb.Request,
  ...
  unsubscribe: {
    path: '/grpc.NodeService/Unsubscribe',
    requestStream: false,
    responseStream: false,
    requestType: entity_request_pb.Request,
    responseType: entity_response_pb.Response,
