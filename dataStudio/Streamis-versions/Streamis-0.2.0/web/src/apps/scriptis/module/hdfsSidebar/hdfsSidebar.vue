...
import weFileTree from '@/apps/scriptis/components/fileTree';
import weNavbar from '@component/navbar/navbar.vue';
import newDialog from '@/apps/scriptis/components/newDialog';
import uploadDialog from '@/apps/scriptis/components/uploadDialog';
import showDialog from '@component/directoryDialog/show.vue';
import weImportToHive from '@/apps/scriptis/components/importToHive';
...
<style src="@/apps/scriptis/assets/styles/sidebar.scss" lang="scss"></style>
