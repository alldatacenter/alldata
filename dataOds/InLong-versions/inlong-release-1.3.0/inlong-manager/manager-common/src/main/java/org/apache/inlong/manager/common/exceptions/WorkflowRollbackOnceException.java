...
public class WorkflowRollbackOnceException extends WorkflowException {
    ...
    public WorkflowRollbackOnceException(String message) {
        super(message);
    }

    public WorkflowRollbackOnceException(String message, Throwable cause) {
        super(message, cause);
    }

    public WorkflowRollbackOnceException(Throwable cause) {
        super(cause);
    }
