...
public class WorkflowNoRollbackException extends WorkflowException {
    ...
    public WorkflowNoRollbackException(String message) {
        super(message);
    }

    public WorkflowNoRollbackException(String message, Throwable cause) {
        super(message, cause);
    }

    public WorkflowNoRollbackException(Throwable cause) {
        super(cause);
    }
