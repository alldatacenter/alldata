                              ...
                              if (forceAcceptData || acceptData(elem)) {
                                  ...
                                  if (data) {
                                      ...
                                      if (cache[id]) {
                                          ...
                                          // nodes IE creates expando attributes along with the
                                          // property IE does not have a removeAttribute function
                                          // on Document nodes
                                          if (!attributes && typeof elem.removeAttribute
                                              ...
                                              // properties from DOM nodes, so set to undefined
                                              // instead
                                              ...
                                              function (elem, computed) {
                                                  if (computed) {
                                                      return (
                                                                 ...
                                                                 // on a disconnected node in IE
                                                                 // throws an error Support: IE8
                                                                 // only getClientRects() errors on
                                                                 // disconnected elems
                                                                 ( jQuery.contains(
        ...
        var result,
            ...
            animation = deferred.promise({
                                             ...
                                             stop: function (gotoEnd) {
                                                 ...
                                                 // the tweens otherwise we skip this part
                          ...
                          type: {
                              set: function (elem, value) {
                                  if (!support.radioValue && value === "radio" &&
                                      ...
                                      // the value in IE8-9 Reset value to default in case type is
    ...
    jQuery.ajaxSettings.xhr = window.ActiveXObject !== undefined ?
        ...
        // Support: IE6-IE8
                              function () {
                                  ...
                                  // Support: IE 9-11
                                  // IE seems to error on cross-domain PATCH requests when ActiveX
                                  // XHR is used. In IE 9+ always use the native XHR. Note: this
                                  // condition won't catch Edge as it doesn't define
                                  // document.documentMode but it also doesn't support ActiveX so
                                  // it won't reach this code.
...
(function ($, window, document, undefined) {
    ...
    function _fnScrollDraw(settings) {
        ...
        if (footer) {
            ...
            footerTrgEls = footer.find('tr'); // the original tfoot is in its own table and must be
                                              // sized
        ...
        // misalignment - try to prevent this by not allowing the table to shrink below its min
        // width
        ...
        var bScrolling = table.height() > divBodyEl.clientHeight || divBody.css('overflow-y')
                                                                    == "scroll";
    ...
    function _fnSortData(settings, idx) {
        ...
        for (var i = 0, ien = settings.aoData.length; i < ien; i++) {
            ...
            if (!row._aSortData[idx] || customSort) {
                cellData = customSort ?
                           customData[i] : // If there was a custom sort function, use data from
                                           // there
    ...
    DataTable = function (options) {
        ...
        /**
         * Redraw the table
         *  @param {bool} [complete=true] Re-filter and resort (if enabled) the table before the
         *     draw.
         *  @dtopt API
         *  @deprecated Since v1.10
         *
        ...
        /**
         * Provide a common method for plug-ins to check the version of DataTables being used, in
         * order to ensure compatibility.
         *  @param {string} sVersion Version string to check for, in the format "X.Y.Z". Note that
        ...
        this.each(function () {
            ...
            for (i = 0, iLen = allSettings.length; i < iLen; i++) {
                ...
                if (s.nTable == this || s.nTHead.parentNode == this || (s.nTFoot
                                                                        && s.nTFoot.parentNode
                                                                           == this)) {
	 ...
	 * object methodExt: [ ... ],              -- array    - Array of Api object definitions to
	 * extend the method result propExt:   [ ... ]               -- array    - Array of Api object
	 * definitions to extend the property
	 *       },
     *       {
	 *         name:     'row'
	 *         val:       {},
    ...
    $.extend(_Api.prototype, {
        ...
        iterator: function (flatten, type, fn, alwaysNew) {
            ...
            for (i = 0, ien = context.length; i < ien; i++) {
                ...
                else if (type === 'column' || type === 'column-rows' || type === 'row' || type
                                                                                          === 'cell') {
    ...
    // object methodExt: [ ... ],              -- array    - Array of Api object definitions to
    // extend the method result propExt:   [ ... ]               -- array    - Array of Api object
    // definitions to extend the property }, { name:     'row' val:       {}, methodExt: [ ... ],
    // propExt:   [ { name:      'data' val:       function () {}, methodExt: [ ... ], propExt:   [
    // ... ] }, ... ] } ]
    ...
    var _selector_run = function (type, selector, selectFn, settings, opts) {
        ...
        if (!selector || selectorType === 'string' || selectorType === 'function' || selector.length
                                                                                     === undefined) {
            selector = [selector];
        }
    ...
    _api_register('destroy()', function (remove) {
        ...
        return this.iterator('table', function (settings) {
            ...
            if (settings.bJUI) {
                $('th span.' + classes.sSortIcon + ', td span.' + classes.sSortIcon, thead)
                    .detach();
    ...
    DataTable.defaults = {
		 ...
		 *          head.getElementsByTagName('th')[0].innerHTML = "Displaying "+(end-start)+"
		 *     records";
		 *        }
		 *      } );
		 *    } )
         ...
         *       <ul>
         *         <li>'H' - jQueryUI theme "header" classes ('fg-toolbar ui-widget-header
         * ui-corner-tl ui-corner-tr ui-helper-clearfix')</li>
         *         <li>'F' - jQueryUI theme "footer" classes ('fg-toolbar ui-widget-header
         * ui-corner-bl ui-corner-br ui-helper-clearfix')</li>
         *       </ul>
         *     </li>
    ...
    DataTable.defaults.column = {
         ...
         *    //   { "phone": 5552368, "phone_filter": "5552368 555-2368", "phone_display":
         *     "555-2368" }
         *    // Here the `phone` integer is used for sorting and type detection, while
         *     `phone_filter`
         *    // (which has both forms) is used for filtering for if a user inputs either format,
         *     while
    ...
    DataTable.ext = _ext = {
         ...
         *  @type string
         */
        build: "dt/jqc-1.12.0,dt-1.10.11",
