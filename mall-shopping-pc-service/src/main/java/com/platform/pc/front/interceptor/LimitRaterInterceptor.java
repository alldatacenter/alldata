package com.platform.pc.front.interceptor;

import com.platform.mall.annotation.RateLimiter;
import com.platform.mall.constant.CommonConstant;
import com.platform.mall.exception.XmallException;
import com.platform.mall.utils.IPInfoUtil;
import com.platform.pc.front.limit.RedisRaterLimiter;
...
public class LimitRaterInterceptor extends HandlerInterceptorAdapter {
    ...
    @Value("${mall.pc.rateLimit.enable}")
    private boolean rateLimitEnable;

    @Value("${mall.pc.rateLimit.limit}")
    private Integer limit;

    @Value("${mall.pc.rateLimit.timeout}")
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response,
        ...
        String token1 = redisRaterLimiter.acquireTokenFromBucket("MALL_PC"+ IPInfoUtil.getIpAddr(request), 10, 1000);
