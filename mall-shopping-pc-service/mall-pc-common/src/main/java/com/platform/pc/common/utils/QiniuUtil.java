package com.platform.pc.common.utils;

import com.platform.pc.common.exception.XmallUploadException;
...
public class QiniuUtil {
     ...
     * 生成上传凭证，然后准备上传
     */
    private static String accessKey = "MV5mQMVv_8DlxCeSZBs6fg_ekG9lXyrAf4VjoGgV";
    private static String secretKey = "oc9QoTNxNUCXSSvOU3ckuXq_kC-5nB5FtAyu7ygp";
    private static String bucket = "mall-shopping-pc";
    private static String origin="http://pz8zk5xal.bkt.clouddn.com/";
