package com.platform.dts.admin.core.trigger;

import com.platform.dts.admin.core.conf.JobAdminConfig;
import com.platform.dts.admin.core.route.ExecutorRouteStrategyEnum;
...
import com.platform.dts.admin.entity.JobGroup;
import com.platform.dts.admin.entity.JobInfo;
import com.platform.dts.admin.entity.JobLog;
import com.platform.dts.admin.tool.query.BaseQueryTool;
import com.platform.dts.admin.tool.query.QueryToolFactory;
import com.platform.dts.admin.util.JSONUtils;
import com.platform.dts.core.biz.ExecutorBiz;
import com.platform.dts.core.biz.impl.ExecutorBizImpl;
...
import com.platform.dts.core.enums.IncrementTypeEnum;
...
/**
 * xxl-job trigger
 * Created by AllDataDC on 2022/11/13
 */
public class JobTrigger {
    ...
    private static void processTrigger(JobGroup group, JobInfo jobInfo, int finalFailRetryCount, TriggerTypeEnum triggerType, int index, int total) {
        ...
        logger.debug(">>>>>>>>>>> Eladmin DTS trigger start, jobId:{}", jobLog.getId());
...
//        jobLog.setTriggerCode(triggerResult.getCode());
        ...
        logger.debug(">>>>>>>>>>> Eladmin DTS trigger end, jobId:{}", jobLog.getId());
    }
    ...
    public static ReturnT<String> runExecutor(TriggerParam triggerParam, String address) {
        ...
        try {
            ...
            logger.error(">>>>>>>>>>> Eladmin DTS trigger error, please check if the executor[{}] is running.", address, e);
