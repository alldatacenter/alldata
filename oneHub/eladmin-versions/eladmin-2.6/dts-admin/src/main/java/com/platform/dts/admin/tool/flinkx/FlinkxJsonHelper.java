...
import com.platform.dts.admin.dto.*;
import com.platform.dts.admin.entity.JobDatasource;
import com.platform.dts.admin.tool.flinkx.reader.*;
import com.platform.dts.admin.tool.flinkx.writer.*;
import com.platform.dts.admin.tool.pojo.*;
import com.platform.dts.admin.tool.flinkx.reader.HanaReader;
import com.platform.dts.admin.tool.flinkx.reader.SqlServerReader;
...
import com.platform.dts.admin.util.JdbcConstants;
import com.platform.dts.core.util.Constants;
import com.platform.dts.admin.dto.ClickhouseReaderDto;
import com.platform.dts.admin.dto.ClickhouseWriterDto;
import com.platform.dts.admin.dto.FlinkXJsonBuildDto;
import com.platform.dts.admin.dto.HbaseReaderDto;
import com.platform.dts.admin.dto.HbaseWriterDto;
import com.platform.dts.admin.dto.HiveReaderDto;
import com.platform.dts.admin.dto.HiveWriterDto;
import com.platform.dts.admin.dto.MongoDBReaderDto;
import com.platform.dts.admin.dto.MongoDBWriterDto;
import com.platform.dts.admin.dto.RdbmsReaderDto;
import com.platform.dts.admin.dto.RdbmsWriterDto;
import com.platform.dts.admin.tool.flinkx.reader.ClickHouseReader;
import com.platform.dts.admin.tool.flinkx.reader.HBaseReader;
import com.platform.dts.admin.tool.flinkx.reader.HiveReader;
import com.platform.dts.admin.tool.flinkx.reader.MongoDBReader;
import com.platform.dts.admin.tool.flinkx.reader.MysqlReader;
import com.platform.dts.admin.tool.flinkx.reader.OracleReader;
import com.platform.dts.admin.tool.flinkx.reader.PostgresqlReader;
import com.platform.dts.admin.tool.flinkx.writer.ClickHouseWriter;
import com.platform.dts.admin.tool.flinkx.writer.HBaseWriter;
import com.platform.dts.admin.tool.flinkx.writer.HanaWriter;
import com.platform.dts.admin.tool.flinkx.writer.HiveWriter;
import com.platform.dts.admin.tool.flinkx.writer.MongoDBWriter;
import com.platform.dts.admin.tool.flinkx.writer.MysqlWriter;
import com.platform.dts.admin.tool.flinkx.writer.OraclelWriter;
import com.platform.dts.admin.tool.flinkx.writer.PostgresqllWriter;
import com.platform.dts.admin.tool.flinkx.writer.SqlServerlWriter;
import lombok.Data;
