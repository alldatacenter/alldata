...
<div style="height: auto;
    ...
    <div style="padding: 10px;padding-bottom: 0px;">
        ...
        <div style="text-align: center;
            ...
            Copyright &copy;${.now?string("yyyy")} <a hover="color: #DA251D;" style="color: #999;" href="https://github.com/AllDataTeam/alldata" target="_blank">AllData</a> 一站式大数据平台 All Rights Reserved.
        </div>
