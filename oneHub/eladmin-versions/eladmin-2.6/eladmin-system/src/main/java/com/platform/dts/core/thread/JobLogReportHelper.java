            ...
            public void run() {
                ...
                while (!toStop) {
                    ...
                    try {
                        ...
                        if (!toStop) {
                            logger.error(">>>>>>>>>>> Eladmin DTS, job log report thread error:{}", e);
                        }
                    }
                ...
                logger.info(">>>>>>>>>>> Eladmin DTS, job log report thread stop");

            }
        });
        logrThread.setDaemon(true);
        logrThread.setName("Eladmin DTS, admin JobLogReportHelper");
        logrThread.start();
    }
