...
import com.platform.dts.dto.*;
import com.platform.dts.entity.JobDatasource;
import com.platform.dts.tool.flinkx.reader.*;
import com.platform.dts.tool.flinkx.writer.*;
import com.platform.dts.tool.pojo.*;
import com.platform.dts.tool.flinkx.reader.HanaReader;
import com.platform.dts.tool.flinkx.reader.SqlServerReader;
...
import com.platform.dts.util.JdbcConstants;
import com.platform.dts.core.util.Constants;
import com.platform.dts.dto.ClickhouseReaderDto;
import com.platform.dts.dto.ClickhouseWriterDto;
import com.platform.dts.dto.FlinkXJsonBuildDto;
import com.platform.dts.dto.HbaseReaderDto;
import com.platform.dts.dto.HbaseWriterDto;
import com.platform.dts.dto.HiveReaderDto;
import com.platform.dts.dto.HiveWriterDto;
import com.platform.dts.dto.MongoDBReaderDto;
import com.platform.dts.dto.MongoDBWriterDto;
import com.platform.dts.dto.RdbmsReaderDto;
import com.platform.dts.dto.RdbmsWriterDto;
import com.platform.dts.tool.flinkx.reader.ClickHouseReader;
import com.platform.dts.tool.flinkx.reader.HBaseReader;
import com.platform.dts.tool.flinkx.reader.HiveReader;
import com.platform.dts.tool.flinkx.reader.MongoDBReader;
import com.platform.dts.tool.flinkx.reader.MysqlReader;
import com.platform.dts.tool.flinkx.reader.OracleReader;
import com.platform.dts.tool.flinkx.reader.PostgresqlReader;
import com.platform.dts.tool.flinkx.writer.ClickHouseWriter;
import com.platform.dts.tool.flinkx.writer.HBaseWriter;
import com.platform.dts.tool.flinkx.writer.HanaWriter;
import com.platform.dts.tool.flinkx.writer.HiveWriter;
import com.platform.dts.tool.flinkx.writer.MongoDBWriter;
import com.platform.dts.tool.flinkx.writer.MysqlWriter;
import com.platform.dts.tool.flinkx.writer.OraclelWriter;
import com.platform.dts.tool.flinkx.writer.PostgresqllWriter;
import com.platform.dts.tool.flinkx.writer.SqlServerlWriter;
import lombok.Data;
