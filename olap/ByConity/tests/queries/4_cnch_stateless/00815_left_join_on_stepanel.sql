...
CREATE TABLE fact_cpc_clicks (model_id UInt8) ENGINE = CnchMergeTree order by model_id;
CREATE TABLE dim_model (model_id UInt8) ENGINE = CnchMergeTree order by model_id;
