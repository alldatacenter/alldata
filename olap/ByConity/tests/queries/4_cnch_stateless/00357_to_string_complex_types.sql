...
SELECT (number, toString(number), range(number)) AS x, toString((number, toString(number), range(number))) FROM system.numbers LIMIT 10;
...
SELECT (number, toString(number), range(number)) AS x, CAST((number, toString(number), range(number)) AS String) FROM system.numbers LIMIT 10;
