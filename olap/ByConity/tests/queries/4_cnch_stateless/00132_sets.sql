...
SELECT (number, number + 1, number + 2, number + 3) IN (1, 2, 3, 4) FROM system.numbers LIMIT 3;
SELECT (number, number + 1, number + 2, number + 3, number - 1) IN (1, 2, 3, 4, 0) FROM system.numbers LIMIT 3;
SELECT (number, number + 1, toString(number + 2), number + 3, number - 1) IN (1, 2, '3', 4, 0) FROM system.numbers LIMIT 3;
