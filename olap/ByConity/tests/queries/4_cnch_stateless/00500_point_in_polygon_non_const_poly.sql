...
create table polygons ( id Int32, poly Array(Tuple(Int32, Int32))) engine = CnchMergeTree ORDER BY tuple();
...
create table polygons ( id Int32, pt Tuple(Int32, Int32), poly Array(Tuple(Int32, Int32))) engine = CnchMergeTree ORDER BY tuple();
...
create table polygons ( id Int32, poly Array(Array(Tuple(Int32, Int32)))) engine = CnchMergeTree ORDER BY tuple();
...
create table polygons ( id Int32, pt Tuple(Int32, Int32), poly Array(Array(Tuple(Int32, Int32)))) engine = CnchMergeTree ORDER BY tuple();
