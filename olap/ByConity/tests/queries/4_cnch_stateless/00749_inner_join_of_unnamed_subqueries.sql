...
CREATE TABLE left_table(APIKey Int32, SomeColumn String) ENGINE = CnchMergeTree ORDER BY tuple();

INSERT INTO left_table VALUES(1, 'somestr');

CREATE TABLE right_table(APIKey Int32, EventValueForPostback String) ENGINE = CnchMergeTree ORDER BY tuple();
