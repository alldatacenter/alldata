...
CREATE TABLE prewhere_alias (a UInt8,  b Int32,  c UInt8 ALIAS a,  d Int64 ALIAS b + 1, e Int32 alias a + b) ENGINE = CnchMergeTree ORDER BY tuple();
...
select '-';
select a from prewhere_alias prewhere c = 1 and e = 2;
select b from prewhere_alias prewhere c = 1 and e = 2;
select c from prewhere_alias prewhere c = 1 and e = 2;
select d from prewhere_alias prewhere c = 1 and e = 2;
select '-';
select a from prewhere_alias prewhere c and e;
select b from prewhere_alias prewhere c and e;
select c from prewhere_alias prewhere c and e;
select d from prewhere_alias prewhere c and e;
drop table if exists prewhere_alias;
