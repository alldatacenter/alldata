...
CREATE TABLE aggregates (d Date, s AggregateFunction(uniq, UInt64)) ENGINE = CnchMergeTree() PARTITION BY toYYYYMM(d) ORDER BY d SETTINGS index_granularity = 8192;
