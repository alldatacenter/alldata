        ...
        implements OrcAggregatedMemoryContext
{
    ...
    {
        return new HiveOrcAggregatedMemoryContext(delegate.newAggregatedMemoryContext());
    }

    @Override
    public OrcLocalMemoryContext newOrcLocalMemoryContext(String allocationTag)
    {
        return new HiveOrcLocalMemoryContext(delegate.newLocalMemoryContext(allocationTag));
    }
