...
CREATE TABLE IF NOT EXISTS decimal (x DECIMAL(10, -2)) ENGINE = CnchMergeTree ORDER BY tuple(); -- { serverError 69 }
CREATE TABLE IF NOT EXISTS decimal (x DECIMAL(10, 15)) ENGINE = CnchMergeTree ORDER BY tuple(); -- { serverError 69 }
CREATE TABLE IF NOT EXISTS decimal (x DECIMAL(0, 0)) ENGINE = CnchMergeTree ORDER BY tuple(); -- { serverError 69 }
