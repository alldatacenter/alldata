 ...
 * "usage cost" of different {@link org.apache.druid.segment.data.BitmapSerdeFactory}.
 *
 * @see #iter(IterState)
...
public class BitmapIterationBenchmark
{
  ...
  /**
   * General benchmark of bitmap iteration, this is a part of {@link org.apache.druid.segment.IndexMerger#merge} and
   ...
   * from query processing of historical nodes, when {@link org.apache.druid.segment.filter.AndFilter} is used.
   */
  @Benchmark
   ...
   * {@link org.apache.druid.query.filter.RegexDimFilter}, {@link org.apache.druid.query.filter.SearchQueryDimFilter} and similar are
   * used.
   */
  @Benchmark
